...
public interface Visitor
{
  ...
  Object Visit(Rule_transformer_quotedvalue rule);
  Object Visit(Rule_transformer_numericvalue rule);
  Object Visit(Rule_transformer_option rule);
  Object Visit(Rule_transformer_stringvalue rule);
  Object Visit(Rule_transformer_char rule);
  Object Visit(Rule_transform_char rule);
