...
sealed public class Rule_h16:Rule
{
  private Rule_h16(String spelling, List<Rule> rules) :
  base(spelling, rules)
  {
  }
  ...
  public static Rule_h16 Parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_h16(context.text.Substring(a0.start, a0.end - a0.start), a0.rules);
    }
    else
    {
        context.index = s0;
